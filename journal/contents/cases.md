...
| Статья                                                                                                                                                                    | Что внутри                                                                                                                                                                                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Цифровая призотека для БумБастик**](/journal/cases/cifrovaya-prizoteka-dlya-bumastic)                                                                                   | Что если призотека аркадного парка — это не склад с конфетами, а главный инструмент удержания? Разбираем кейс БумБастик, где мы перестроили экономику 320+ призов, выстроили систему пяти редкостей и запустили цифровой каталог, который работает до визита, во время и после. История о том, как лестница от значка до PlayStation превращает разового гостя в постоянного. |
| [**Калькулятор инвестиций для Optima Space**](/journal/cases/kalkulyator-investiciy-dlya-optima-space)                                                                     | PDF на 40 страниц, часовая встреча с менеджером и ни одной цифры под конкретную сумму — так выглядит путь инвестора в большинстве проектов. Мы сделали иначе. Интерактивный калькулятор с шестью классами активов, четырьмя стратегиями и встроенным советником заменяет первую встречу и работает 24/7. Кейс о том, как наглядный интерфейс продаёт лучше любой презентации. |
