...
const allProjects = ref<Project[]>([
  ...
  { id: 'proj20', title: 'Архитектурное портфолио', subtitle: 'Tanurkova Arch Design', specialization: 'Архитектурное бюро', website: null, images: [], videos: [], tags: ['Бренд', 'Веб', 'Анимация', 'Видео'], caseUrl: null, moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/175565499/Tanurkova-Arch-Design-Identity-Website', launchDate: '09.09.2023', buildTime: '70дн', status: 'Отложен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_09_09_2023.svg' },
  ...
  { id: 'proj22', title: 'Бассейн мечты', subtitle: 'Блумкидс', specialization: 'Детский бассейн', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Бренд', 'Веб', 'Анимация', 'Видео', 'CJM', 'Лояльность', 'Продажи', 'Торговая среда'], caseUrl: 'https://runscale.ru/journal/cases/sozdayom-bassein-mechty.html', moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/175530883/blumkids-ajdentika-i-veb-sajt', launchDate: '10.12.2022', buildTime: '235дн', status: 'Отложен', mrBranded: true, details: 'Воронка продаж абонементов, матрица программ, система лояльности, регламенты персонала и сайт для записи и коммуникаций.', logo: '/ars/id-icons/id_icon_10_12_2022.svg' },
  ...
  { id: 'proj24', title: 'Платформа события', subtitle: 'World Plastics Summit 2022', specialization: 'Международный саммит', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Бренд', 'Веб', 'Анимация', 'Видео'], caseUrl: 'https://runscale.ru/journal/cases/kak-obedinit-nauku-iskusstvo-i-kommunikaciyu-dlya-resheniya-globalnoi-problemy.html', moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/156308617/World-Plastics-Summit-Brand-Identity-Website', launchDate: '24.03.2022', buildTime: '50дн', status: 'Запущен', mrBranded: true, details: 'Манифест саммита, логотип, айдентика, бренд-видео и сайт-сервис для участников.', logo: '/ars/id-icons/id_icon_24_03_2022.svg' },
  ...
  { id: 'proj26', title: 'Образовательный профайл', subtitle: 'Modelex Education', specialization: 'Школа', website: 'https://modelex.mc', images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб'], caseUrl: null, moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/175486955/Modelex-Identity-Website', launchDate: '01.06.2021', buildTime: '90дн', status: 'Запущен', mrBranded: true, details: 'Курсы, преподаватели, расписание, отзывы и айдентика для набора учеников.', logo: '/ars/id-icons/id_icon_01_06_2021.svg' },
  { id: 'proj27', title: 'Культурный профайл', subtitle: 'GALA RUSSE', specialization: 'Организация культурных событий', website: null, images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб', 'Видео'], caseUrl: null, moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/175498363/GALA-RUSSE-Identity-website', launchDate: '02.04.2021', buildTime: '60дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_02_04_2021.svg' },
  ...
  { id: 'proj29', title: 'Сервисный профайл', subtitle: 'EASYBUSY', specialization: 'Консьерж-сервис', website: 'https://easybusy.fr/', images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб'], caseUrl: null, moduleUrl: null, behanceUrl: 'https://behance.net/orxaos', launchDate: '21.09.2020', buildTime: '60дн', status: 'Запущен', mrBranded: true, details: 'Сайт с описанием сервисов, тарифов, кейсов и контактов для онбординга B2B-клиентов.', logo: '/ars/id-icons/id_icon_21_09_2020.svg' },
