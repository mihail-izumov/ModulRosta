...
const allProjects = ref<Project[]>([
  ...
  { id: 'proj40', title: 'WOODLED Студия', subtitle: 'WOODLED', specialization: 'Производитель дизайнерских светильников из дерева', website: 'https://woodled-studio.ru', images: [{ src: '/gallery/proj40/images/run_b00m.fun_ban_1.jpg' }], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Бренд', 'Веб', 'Анимация', 'Видео', 'CJM'], caseUrl: null, moduleUrl: null, behanceUrl: null, launchDate: '09.06.2026', buildTime: '57дн', status: 'Запущен', mrBranded: false, details: '', logo: '/ars/id-icons/id_icon_09_06_2026.svg' },
