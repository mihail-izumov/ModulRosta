...
const allProjects = ref<Project[]>([
  { id: 'proj1', title: 'Приложение-компаньон', subtitle: 'b00m.fun', specialization: 'Аркадные парки', website: 'https://b00m.fun/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['Чекап', 'Стратегия', 'Бренд', 'Веб', 'Стандарты'], caseUrl: null, behanceUrl: null, launchDate: '18.03.2026', buildTime: '45дн', status: 'Скоро запуск', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_01_03_2026.svg' },
  ...
  { id: 'proj5', title: 'Конструктор Сигнала', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/pro/reserve.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '15.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '', logo: null },
  { id: 'proj6', title: 'LTV Калькулятор', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/pro/ltvcalc.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '10.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '', logo: null },
  ...
  { id: 'proj11', title: 'Прогноз выручки', subtitle: 'Сигнал – Кофейни', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/invest/calc.html', images: [], videos: [], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '06.08.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '', logo: null },
  { id: 'proj12', title: 'Симулятор Самары', subtitle: 'Сигнал – Кофейни', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/invest/sim.html', images: [], videos: [], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '30.07.2025', buildTime: '15дн', status: 'Запущен', mrBranded: false, details: '', logo: null },
  ...
  { id: 'proj14', title: 'Игристая брассерия', subtitle: 'BRIMS', specialization: 'Ресторан с морской душой', website: 'https://brims63.ru', images: [], videos: [], tags: ['Чекап', 'Бренд', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '28.02.2025', buildTime: '150дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_28_02_2025.svg' },
  { id: 'proj15', title: 'Юридический профайл', subtitle: 'ЮрТраст', specialization: 'Юридическая компания', website: 'https://jurtrust.ru', images: [], videos: [], tags: ['Бренд', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '23.07.2024', buildTime: '5дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_23_07_2024.svg' },
  ...
  { id: 'proj17', title: 'ИИ-трекер качества', subtitle: 'Конкордия-Авто', specialization: 'Импорт автомобилей', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/kak-ii-assistenty-pomogayut-uluchshat-prodazhi.html', behanceUrl: null, launchDate: '06.05.2024', buildTime: '35дн', status: 'Отложен', mrBranded: false, details: 'ИИ-ассистент анализирует активность менеджеров, фиксирует динамику и даёт персональные рекомендации по развитию навыков и повышению конверсии.', logo: null },
  ...
  { id: 'proj25', title: 'Крафт-франшиза', subtitle: 'Ермолаевъ', specialization: 'Сеть магазинов пивоварни', website: 'https://ermolaev.beer/', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Продажи', 'Торговая среда'], caseUrl: 'https://runscale.ru/journal/cases/bolshuyu-svetlyi-lager-khelles.html', behanceUrl: null, launchDate: '27.12.2021', buildTime: '70дн', status: 'Отложен', mrBranded: false, details: 'Новый формат магазинов-баров: зонирование, пивная матрица 25–30 SKU, финмодель с рентабельностью 20%+ и окупаемостью до 1,5 лет.', logo: null },
  ...
  { id: 'proj28', title: 'Новый персонаж', subtitle: 'Желток Белток', specialization: 'Аксайская птицефабрика', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка'], caseUrl: null, behanceUrl: null, launchDate: '18.11.2020', buildTime: '55дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_18_11_2020.svg' },
  ...
  { id: 'proj30', title: 'Маркетинговый контур', subtitle: 'SMSTRETCHING', specialization: 'Сеть студий стретчинга', website: 'https://smstretching.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Автоматизация', 'Веб', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/avtomatiziruem-marketing-fitnesa.html', behanceUrl: null, launchDate: '02.03.2020', buildTime: '30дн', status: 'Отложен', mrBranded: false, details: 'Сквозная аналитика, интеграция amoCRM ↔ 1C Фитнес, 12 триггерных email-цепочек.', logo: null },
  { id: 'proj31', title: 'Цифровая витрина', subtitle: 'WOODLED', specialization: 'Производитель дизайнерских светильников', website: 'https://woodled.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Упаковка', 'Веб', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/lakonichnyi-ekodizain-dlya-komfortnoi-zhizni.html', behanceUrl: null, launchDate: '16.02.2020', buildTime: '60дн', status: 'Запущен', mrBranded: false, details: 'Новый сайт-витрина и интернет-магазин, каталог 3D-моделей, упаковка для Rotor.', logo: null },
  ...
  { id: 'proj33', title: 'Витрина бренда', subtitle: 'RAW BITES', specialization: 'Продукты питания', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка', 'Веб', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '30.11.2019', buildTime: '90дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_30_11_2019.svg' },
  { id: 'proj34', title: 'Конструктор праздника', subtitle: 'СУПЕРЛЕНД', specialization: 'Сеть детских развлекательных центров', website: 'https://superland.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'CJM'], caseUrl: 'https://runscale.ru/journal/cases/sozdayom-nezabyvaemye-vpechatleniya-dlya-vsei-semi.html', behanceUrl: null, launchDate: '22.08.2018', buildTime: '50дн', status: 'Отложен', mrBranded: false, details: 'Онлайн-калькулятор банкетов, система пакетных предложений и торговые маршруты семьи (CJM).', logo: null },
  { id: 'proj35', title: 'Фирменный магазин', subtitle: 'Dymicana', specialization: 'GoPro - Казань', website: null, images: [], videos: [], tags: [], caseUrl: null, behanceUrl: null, launchDate: '18.11.2016', buildTime: '90дн', status: 'Запущен', mrBranded: false, details: '', logo: null },
  ...
  { id: 'proj38', title: 'Центр психологической помощи', subtitle: 'Школа Позитивной Психологии', specialization: 'Образовательный проект', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Бренд', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '01.06.2011', buildTime: '95дн', status: 'Отложен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_01_06_2011.svg' },
  { id: 'proj39', title: 'Ресторан и Гриль', subtitle: 'Морошка', specialization: 'Семейный ресторан', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка', 'Веб', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '01.11.2010', buildTime: '125дн', status: 'Запущен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_01_11_2010.svg' }
])
