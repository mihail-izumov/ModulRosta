...
const allProjects = ref<Project[]>([
  { id: 'proj41', title: 'Игровая система', subtitle: 'DRPCS', specialization: 'Кран-машины', website: null, images: [], videos: [], tags: ['Стратегия', 'Автоматизация', 'Бренд', 'Веб', 'Анимация', 'Лояльность'], caseUrl: null, moduleUrl: null, behanceUrl: null, launchDate: '01.10.2026', buildTime: '', status: 'Скоро запуск', mrBranded: false, details: '', logo: '/ars/id-icons/id_icon_02_05_2026.svg' },
