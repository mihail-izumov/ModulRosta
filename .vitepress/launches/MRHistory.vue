...
const allProjects = ref<Project[]>([
  ...
  { id: 'proj20', title: 'Архитектурное портфолио', subtitle: 'Tanurkova Arch Design', specialization: 'Архитектурное бюро', website: null, images: [{ src: '/gallery/proj20/images/tanurkova-main-desktop.jpg' }, { src: '/gallery/proj20/images/tanurkova-insta-profile-pack.jpg' }], videos: [], tags: ['Бренд', 'Веб', 'Анимация', 'Видео'], caseUrl: null, moduleUrl: null, behanceUrl: 'https://www.behance.net/gallery/175565499/Tanurkova-Arch-Design-Identity-Website', launchDate: '09.09.2023', buildTime: '70дн', status: 'Отложен', mrBranded: true, details: '', logo: '/ars/id-icons/id_icon_09_09_2023.svg' },
