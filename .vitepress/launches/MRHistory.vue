...
const allProjects = ref<Project[]>([
  { id: 'proj40', title: 'Дом для WOODLED Rotor', subtitle: 'WOODLED', specialization: 'Производитель дизайнерских светильников из дерева', website: 'https://woodled.ru', images: [], videos: [], tags: ['Стратегия', 'R&D', 'Автоматизация', 'Веб', 'Анимация', 'Видео', 'CJM', 'Стандарты'], caseUrl: null, moduleUrl: null, behanceUrl: null, launchDate: '01.05.2026', buildTime: '', status: 'Скоро запуск', mrBranded: false, details: '', logo: null },
