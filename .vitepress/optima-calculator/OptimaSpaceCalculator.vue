...
.mobile-warning-card h2 { font-size: 18px; font-weight: 600; margin: 16px 0 12px; border: none !important; }
...
.step-title { font-size: 12px; font-weight: 600; color: #fff; margin: 8px 0 4px; }
