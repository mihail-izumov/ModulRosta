...
const countdown = computed(() => {
  ...
  if (diff <= 0) return { months: 0, days: 0, launched: true }
  
  const days = Math.floor(diff / (1000 * 60 * 60 * 24))
  const months = Math.floor(days / 30)
  const remainingDays = days % 30
  
  return { months, days: remainingDays, totalDays: days, launched: false }
})
...
<template>
  <div class="osc-calculator">
    ...
    <section class="osc-summary-section">
      ...
      <div class="osc-summary-content">
        ...
        <div class="osc-summary-total">
          ...
          <div class="osc-total-sub">Из них рост: +{{ formatCurrency(totalExpectedIncome) }}</div>
    ...
    <footer class="osc-footer">
      <a href="/terms" target="_blank">Условия</a>
      <span>•</span>
      <a href="/faq" target="_blank">Вопросы</a>
      <span>•</span>
      <a href="https://t.me/paimukov" target="_blank">Telegram</a>
      <span>•</span>
      <a href="mailto:info@profitrooms.ru">Email</a>
    </footer>

    <div class="osc-disclaimer">
      Данный расчёт носит информационный характер. Инвестиции связаны с рисками.
    </div>
