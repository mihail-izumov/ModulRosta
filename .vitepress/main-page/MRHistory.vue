...
interface Project { id: string; title: string; subtitle: string; specialization: string; website: string | null; images: string[]; videos: string[]; tags: string[]; caseUrl: string | null; behanceUrl: string | null; launchDate: string; buildTime: string; status: string; mrBranded: boolean; details: string }
...
const allProjects = ref<Project[]>([
  { id: 'proj1', title: 'Приложение-компаньон', subtitle: 'b00m.fun', specialization: 'Аркадные парки', website: 'https://b00m.fun/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['Чекап', 'Стратегия', 'Бренд', 'Веб', 'Стандарты'], caseUrl: null, behanceUrl: null, launchDate: '18.03.2026', buildTime: '45дн', status: 'Скоро запуск', mrBranded: true, details: '' },
  { id: 'proj2', title: 'Калькулятор инвестора', subtitle: 'Optima Space', specialization: 'Сервисные офисы', website: 'https://profitrooms.ru/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Веб', 'Продажи'], caseUrl: 'https://runscale.ru/optima-space/invest', behanceUrl: null, launchDate: '02.03.2026', buildTime: '10дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj3', title: 'Генератор сториз', subtitle: 'Корж', specialization: 'Сеть кофеен', website: 'https://korzhcoffee.ru/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: 'https://cffx.ru/signal/korzh/gift', behanceUrl: null, launchDate: '25.12.2025', buildTime: '10дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj4', title: 'Калькулятор инвестора', subtitle: 'Корж', specialization: 'Сеть кофеен', website: 'https://korzhcoffee.ru/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: 'https://cffx.ru/signal/korzh/invest.html', behanceUrl: null, launchDate: '15.12.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj5', title: 'Конструктор Сигнала', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/pro/reserve.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '15.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj6', title: 'LTV Калькулятор', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/pro/ltvcalc.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '10.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj7', title: 'Диалоги Сигнала', subtitle: 'Корж', specialization: 'Сеть кофеен', website: 'https://korzhcoffee.ru/', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['ИИ', 'Чекап', 'R&D', 'Автоматизация', 'Веб', 'Видео'], caseUrl: 'https://cffx.ru/korzh.html', behanceUrl: null, launchDate: '15.10.2025', buildTime: '30дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj8', title: 'ИИ-ассистент Анна', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/pro/anna.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['ИИ', 'R&D'], caseUrl: null, behanceUrl: null, launchDate: '26.09.2025', buildTime: '25дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj9', title: 'Индекс Роста', subtitle: 'Сигнал – Кофейни', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/invest/smr.html', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '31.08.2025', buildTime: '30дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj10', title: 'Тикет-система', subtitle: 'Сигнал', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru', images: ['Главная', 'Функционал', 'Детали'], videos: ['Обзор'], tags: ['ИИ', 'Чекап', 'Автоматизация', 'Бренд', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '30.08.2025', buildTime: '60дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj11', title: 'Прогноз выручки', subtitle: 'Сигнал – Кофейни', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/invest/calc.html', images: [], videos: [], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '06.08.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj12', title: 'Симулятор Самары', subtitle: 'Сигнал – Кофейни', specialization: 'Система обратной связи высокого качества', website: 'https://cffx.ru/invest/sim.html', images: [], videos: [], tags: ['R&D'], caseUrl: null, behanceUrl: null, launchDate: '30.07.2025', buildTime: '15дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj13', title: 'БАД', subtitle: 'Bengal Boost', specialization: 'Корма для диких кошек', website: null, images: [], videos: [], tags: ['Чекап', 'Бренд', 'Упаковка'], caseUrl: null, behanceUrl: null, launchDate: '20.06.2025', buildTime: '15дн', status: 'Отложен', mrBranded: true, details: '' },
  { id: 'proj14', title: 'Игристая брассерия', subtitle: 'BRIMS', specialization: 'Ресторан с морской душой', website: 'https://brims63.ru', images: [], videos: [], tags: ['Чекап', 'Бренд', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '28.02.2025', buildTime: '150дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj15', title: 'Юридический профайл', subtitle: 'ЮрТраст', specialization: 'Юридическая компания', website: 'https://jurtrust.ru', images: [], videos: [], tags: ['Бренд', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '23.07.2024', buildTime: '5дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj16', title: 'Захват контактов', subtitle: 'Конкордия-Авто', specialization: 'Импорт автомобилей', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Стандарты', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/kak-ii-resheniya-pomogayut-povysit-effektivnost-zaprosa-kontaktov-klientov.html', behanceUrl: null, launchDate: '26.05.2024', buildTime: '20дн', status: 'Отложен', mrBranded: false, details: 'ИИ-модуль и сценарии для запроса контактов: стандарты формулировок, работа с возражениями и повторные попытки, резюме звонков в Telegram.' },
  { id: 'proj17', title: 'ИИ-трекер качества', subtitle: 'Конкордия-Авто', specialization: 'Импорт автомобилей', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/kak-ii-assistenty-pomogayut-uluchshat-prodazhi.html', behanceUrl: null, launchDate: '06.05.2024', buildTime: '35дн', status: 'Отложен', mrBranded: false, details: 'ИИ-ассистент анализирует активность менеджеров, фиксирует динамику и даёт персональные рекомендации по развитию навыков и повышению конверсии.' },
  ...
  { id: 'proj19', title: 'Конструктор туров', subtitle: 'Август Глэмпинг', specialization: 'Глэмпинг', website: 'https://augustglamping.ru', images: [], videos: [], tags: ['Чекап', 'R&D', 'Автоматизация', 'Бренд', 'Веб', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '30.09.2023', buildTime: '60дн', status: 'Отложен', mrBranded: true, details: '' },
  { id: 'proj20', title: 'Архитектурное портфолио', subtitle: 'Tanurkova Arch Design', specialization: 'Архитектурное бюро', website: null, images: [], videos: [], tags: ['Бренд', 'Веб', 'Анимация', 'Видео'], caseUrl: null, behanceUrl: 'https://www.behance.net/gallery/175565499/Tanurkova-Arch-Design-Identity-Website', launchDate: '09.09.2023', buildTime: '70дн', status: 'Отложен', mrBranded: true, details: '' },
  { id: 'proj21', title: 'Цифровое наследие', subtitle: 'Фонд Хворостовского', specialization: 'Благотворительный фонд', website: 'https://hvorostovsky.com', images: [], videos: [], tags: ['Автоматизация', 'Бренд', 'Веб', 'Видео'], caseUrl: 'https://runscale.ru/journal/cases/kak-my-prevratili-nasledie-khvorostovskogo-v-instrument-dlya-pomoshi-detyam.html', behanceUrl: 'https://www.behance.net/gallery/175592297/sajt-fonda-hvorostovskogo', launchDate: '27.06.2023', buildTime: '40дн', status: 'Запущен', mrBranded: true, details: 'Новый сайт с базой событий и историй детей, «Линией времени», медиатекой и приёмом пожертвований через RoboKassa.' },
  { id: 'proj22', title: 'Бассейн мечты', subtitle: 'Блумкидс', specialization: 'Детский бассейн', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'Автоматизация', 'Бренд', 'Веб', 'Анимация', 'Видео', 'CJM', 'Лояльность', 'Продажи', 'Торговая среда'], caseUrl: 'https://runscale.ru/journal/cases/sozdayom-bassein-mechty.html', behanceUrl: 'https://www.behance.net/gallery/175530883/blumkids-ajdentika-i-veb-sajt', launchDate: '10.12.2022', buildTime: '235дн', status: 'Отложен', mrBranded: true, details: 'Воронка продаж абонементов, матрица программ, система лояльности, регламенты персонала и сайт для записи и коммуникаций.' },
  { id: 'proj23', title: 'Фитнес-экосистема', subtitle: 'FIZ Культура', specialization: 'Сеть фитнес-клубов', website: 'https://fizkultura63.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'CJM', 'Лояльность', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/delaem-fitnes-personalnym.html', behanceUrl: null, launchDate: '12.05.2022', buildTime: '110дн', status: 'Отложен', mrBranded: false, details: 'Новый формат «сухой фитнес + SPA», сегментация, CJM, бонусная и реферальная системы, программа адаптации и ТЗ на приложение.' },
  { id: 'proj24', title: 'Платформа события', subtitle: 'World Plastics Summit 2022', specialization: 'Международный саммит', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Бренд', 'Веб', 'Анимация', 'Видео'], caseUrl: 'https://runscale.ru/journal/cases/kak-obedinit-nauku-iskusstvo-i-kommunikaciyu-dlya-resheniya-globalnoi-problemy.html', behanceUrl: 'https://www.behance.net/gallery/156308617/World-Plastics-Summit-Brand-Identity-Website', launchDate: '24.03.2022', buildTime: '50дн', status: 'Запущен', mrBranded: true, details: 'Манифест саммита, логотип, айдентика, бренд-видео и сайт-сервис для участников.' },
  { id: 'proj25', title: 'Крафт-франшиза', subtitle: 'Ермолаевъ', specialization: 'Сеть магазинов пивоварни', website: 'https://ermolaev.beer/', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Продажи', 'Торговая среда'], caseUrl: 'https://runscale.ru/journal/cases/bolshuyu-svetlyi-lager-khelles.html', behanceUrl: null, launchDate: '27.12.2021', buildTime: '70дн', status: 'Отложен', mrBranded: false, details: 'Новый формат магазинов-баров: зонирование, пивная матрица 25–30 SKU, финмодель с рентабельностью 20%+ и окупаемостью до 1,5 лет.' },
  { id: 'proj26', title: 'Образовательный профайл', subtitle: 'Modelex Education', specialization: 'Школа', website: 'https://modelex.mc', images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб'], caseUrl: null, behanceUrl: 'https://www.behance.net/gallery/175486955/Modelex-Identity-Website', launchDate: '01.06.2021', buildTime: '90дн', status: 'Запущен', mrBranded: true, details: 'Курсы, преподаватели, расписание, отзывы и айдентика для набора учеников.' },
  { id: 'proj27', title: 'Культурный профайл', subtitle: 'GALA RUSSE', specialization: 'Организация культурных событий', website: null, images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб', 'Видео'], caseUrl: null, behanceUrl: 'https://www.behance.net/gallery/175498363/GALA-RUSSE-Identity-website', launchDate: '02.04.2021', buildTime: '60дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj28', title: 'Новый персонаж', subtitle: 'Желток Белток', specialization: 'Аксайская птицефабрика', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка'], caseUrl: null, behanceUrl: null, launchDate: '18.11.2020', buildTime: '55дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj29', title: 'Сервисный профайл', subtitle: 'EASYBUSY', specialization: 'Консьерж-сервис', website: 'https://easybusy.fr/', images: [], videos: [], tags: ['Стратегия', 'Бренд', 'Веб'], caseUrl: null, behanceUrl: 'https://behance.net/orxaos', launchDate: '21.09.2020', buildTime: '60дн', status: 'Запущен', mrBranded: true, details: 'Сайт с описанием сервисов, тарифов, кейсов и контактов для онбординга B2B-клиентов.' },
  { id: 'proj30', title: 'Маркетинговый контур', subtitle: 'SMSTRETCHING', specialization: 'Сеть студий стретчинга', website: 'https://smstretching.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Автоматизация', 'Веб', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/avtomatiziruem-marketing-fitnesa.html', behanceUrl: null, launchDate: '02.03.2020', buildTime: '30дн', status: 'Отложен', mrBranded: false, details: 'Сквозная аналитика, интеграция amoCRM ↔ 1C Фитнес, 12 триггерных email-цепочек.' },
  { id: 'proj31', title: 'Цифровая витрина', subtitle: 'WOODLED', specialization: 'Производитель дизайнерских светильников', website: 'https://woodled.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Упаковка', 'Веб', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/lakonichnyi-ekodizain-dlya-komfortnoi-zhizni.html', behanceUrl: null, launchDate: '16.02.2020', buildTime: '60дн', status: 'Запущен', mrBranded: false, details: 'Новый сайт-витрина и интернет-магазин, каталог 3D-моделей, упаковка для Rotor.' },
  { id: 'proj32', title: 'Новая стратегия', subtitle: 'SMSTRETCHING', specialization: 'Сеть студий стретчинга', website: 'https://smstretching.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/trenirovki-kak-v-studii-tolko-doma.html', behanceUrl: null, launchDate: '08.02.2020', buildTime: '130дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj33', title: 'Витрина бренда', subtitle: 'RAW BITES', specialization: 'Продукты питания', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка', 'Веб', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '30.11.2019', buildTime: '90дн', status: 'Запущен', mrBranded: true, details: '' },
  { id: 'proj34', title: 'Конструктор праздника', subtitle: 'СУПЕРЛЕНД', specialization: 'Сеть детских развлекательных центров', website: 'https://superland.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'CJM'], caseUrl: 'https://runscale.ru/journal/cases/sozdayom-nezabyvaemye-vpechatleniya-dlya-vsei-semi.html', behanceUrl: null, launchDate: '22.08.2018', buildTime: '50дн', status: 'Отложен', mrBranded: false, details: 'Онлайн-калькулятор банкетов, система пакетных предложений и торговые маршруты семьи (CJM).' },
  { id: 'proj35', title: 'Фирменный магазин', subtitle: 'Dymicana', specialization: 'GoPro - Казань', website: null, images: [], videos: [], tags: [], caseUrl: null, behanceUrl: null, launchDate: '18.11.2016', buildTime: '90дн', status: 'Запущен', mrBranded: false, details: '' },
  { id: 'proj36', title: 'Запуск на полку', subtitle: 'Чишминский', specialization: 'Молочный завод', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Бренд', 'Упаковка', 'Веб', 'Лояльность', 'Продажи', 'Торговая среда'], caseUrl: 'https://runscale.ru/journal/cases/slavim-tradicii-kachestva.html', behanceUrl: null, launchDate: '01.06.2016', buildTime: '150дн', status: 'Запущен', mrBranded: true, details: 'Ассортиментная матрица ~75 SKU, ценовая стратегия, новая упаковка, система лояльности и план входа в сети.' },
  { id: 'proj37', title: 'Единая доставка', subtitle: 'Milimon', specialization: 'Сеть ресторанов', website: 'https://milimon.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Автоматизация', 'Веб', 'Стандарты', 'Продажи'], caseUrl: 'https://runscale.ru/journal/cases/uskoryaem-dostavku-edy.html', behanceUrl: null, launchDate: '01.04.2016', buildTime: '60дн', status: 'Запущен', mrBranded: false, details: 'Единый колл-центр, карта покрытия, стандарты для курьеров, система оценок и онлайн-магазин.' },
  { id: 'proj38', title: 'Центр психологической помощи', subtitle: 'Школа Позитивной Психологии', specialization: 'Образовательный проект', website: null, images: [], videos: [], tags: ['Чекап', 'Стратегия', 'Бренд', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '01.06.2011', buildTime: '95дн', status: 'Отложен', mrBranded: true, details: '' },
  { id: 'proj39', title: 'Ресторан и Гриль', subtitle: 'Морошка', specialization: 'Семейный ресторан', website: null, images: [], videos: [], tags: ['Бренд', 'Упаковка', 'Веб', 'Торговая среда'], caseUrl: null, behanceUrl: null, launchDate: '01.11.2010', buildTime: '125дн', status: 'Запущен', mrBranded: true, details: '' }
])

const averageBuildTime = computed(() => {
  const times = allProjects.value.map(p => parseInt(p.buildTime) || 30)
