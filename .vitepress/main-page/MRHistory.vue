...
const allProjects = ref<Project[]>([
  { id: 'proj1', title: 'Приложение-компаньон', subtitle: 'b00m.fun', website: 'https://b00m.fun/', images: ['Главная', 'Каталог', 'Карточка', 'Лояльность'], videos: ['Демо', 'Промо'], tags: ['ИИ', 'R&D', 'Бренд', 'CJM'], caseUrl: null, behanceUrl: null, launchDate: '18.03.2026', buildTime: '45дн', status: 'Скоро запуск', mrBranded: true },
  { id: 'proj2', title: 'Калькулятор инвестора', subtitle: 'Optima Space', website: 'https://profitrooms.ru/', images: ['Dashboard', 'Расчёты', 'Отчёты'], videos: ['Обзор'], tags: ['ИИ', 'Чекап', 'Стратегия', 'Лояльность'], caseUrl: null, behanceUrl: null, launchDate: '02.03.2026', buildTime: '10дн', status: 'Запущен', mrBranded: false },
  { id: 'proj3', title: 'Генератор сториз', subtitle: 'Корж', website: 'https://korzhcoffee.ru/', images: ['Интерфейс', 'Шаблоны', 'Результат'], videos: ['Туториал'], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '25.12.2025', buildTime: '10дн', status: 'Запущен', mrBranded: false },
  { id: 'proj4', title: 'Калькулятор инвестора', subtitle: 'Корж', website: 'https://korzhcoffee.ru/', images: ['Главная', 'Расчёт', 'Результаты'], videos: [], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '15.12.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false },
  { id: 'proj5', title: 'Конструктор Сигнала', subtitle: 'Сигнал', website: 'https://cffx.ru/pro/reserve.html', images: ['Конструктор', 'Превью', 'Экспорт'], videos: ['Демо'], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '15.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false },
  { id: 'proj6', title: 'LTV Калькулятор', subtitle: 'Сигнал', website: 'https://cffx.ru/pro/ltvcalc.html', images: ['Ввод данных', 'Графики', 'Отчёт'], videos: [], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '10.11.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false },
  { id: 'proj7', title: 'Диалоги Сигнала', subtitle: 'Корж', website: 'https://korzhcoffee.ru/', images: ['Чат', 'Настройки', 'Аналитика', 'Интеграции'], videos: ['Обучение'], tags: ['Чекап', 'Стратегия', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '15.10.2025', buildTime: '30дн', status: 'Запущен', mrBranded: false },
  { id: 'proj8', title: 'ИИ-ассистент Анна', subtitle: 'Сигнал', website: 'https://cffx.ru/pro/anna.html', images: ['Интерфейс', 'Диалог', 'База знаний', 'Статистика'], videos: ['Презентация', 'Кейсы'], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '26.09.2025', buildTime: '25дн', status: 'Запущен', mrBranded: false },
  { id: 'proj9', title: 'Индекс Роста', subtitle: 'Сигнал – Кофейни', website: 'https://cffx.ru/invest/smr.html', images: ['Dashboard', 'Метрики', 'Сравнение'], videos: [], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '31.08.2025', buildTime: '30дн', status: 'Запущен', mrBranded: false },
  { id: 'proj10', title: 'Тикет-система', subtitle: 'Сигнал', website: 'https://cffx.ru', images: ['Список тикетов', 'Карточка', 'Фильтры', 'Отчёты', 'Настройки'], videos: ['Обзор системы'], tags: ['Стратегия', 'R&D', 'Бренд'], caseUrl: null, behanceUrl: null, launchDate: '30.08.2025', buildTime: '60дн', status: 'Запущен', mrBranded: true },
  { id: 'proj11', title: 'Прогноз выручки', subtitle: 'Сигнал – Кофейни', website: 'https://cffx.ru/invest/calc.html', images: [], videos: [], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '06.08.2025', buildTime: '5дн', status: 'Запущен', mrBranded: false },
  { id: 'proj12', title: 'Симулятор Самары', subtitle: 'Сигнал – Кофейни', website: 'https://cffx.ru/invest/sim.html', images: [], videos: [], tags: ['Чекап'], caseUrl: null, behanceUrl: null, launchDate: '30.07.2025', buildTime: '15дн', status: 'Запущен', mrBranded: false },
  { id: 'proj13', title: 'БАД', subtitle: 'Bengal Boost', website: null, images: [], videos: [], tags: ['R&D', 'Автоматизация', 'Бренд'], caseUrl: null, behanceUrl: null, launchDate: '20.06.2025', buildTime: '15дн', status: 'Отложен', mrBranded: true },
  { id: 'proj14', title: 'Игристая брассерия', subtitle: 'BRIMS', website: 'https://brims63.ru', images: [], videos: [], tags: ['R&D', 'Бренд', 'Стандарты'], caseUrl: null, behanceUrl: null, launchDate: '28.02.2025', buildTime: '150дн', status: 'Запущен', mrBranded: true },
  { id: 'proj15', title: 'Юридический профайл', subtitle: 'ЮрТраст', website: 'https://jurtrust.ru', images: [], videos: [], tags: ['R&D', 'Бренд'], caseUrl: null, behanceUrl: null, launchDate: '23.07.2024', buildTime: '5дн', status: 'Запущен', mrBranded: true },
  { id: 'proj16', title: 'Захват контактов', subtitle: 'Конкордия-Авто', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'CJM', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '26.05.2024', buildTime: '20дн', status: 'Отложен', mrBranded: false },
  { id: 'proj17', title: 'ИИ-трекер качества', subtitle: 'Конкордия-Авто', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '06.05.2024', buildTime: '35дн', status: 'Отложен', mrBranded: false },
  { id: 'proj18', title: 'Автопилот продаж', subtitle: 'Конкордия-Авто', website: 'https://konkordia-auto.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'CJM', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '31.03.2024', buildTime: '30дн', status: 'Отложен', mrBranded: false },
  { id: 'proj19', title: 'Конструктор туров', subtitle: 'Август Глэмпинг', website: 'https://augustglamping.ru', images: [], videos: [], tags: ['Чекап', 'Стратегия', 'R&D', 'Бренд', 'Лояльность'], caseUrl: null, behanceUrl: null, launchDate: '30.09.2023', buildTime: '60дн', status: 'Отложен', mrBranded: true },
  { id: 'proj20', title: 'Архитектурное портфолио', subtitle: 'Tanurkova Arch Design', website: null, images: [], videos: [], tags: ['R&D', 'Бренд', 'Упаковка', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '09.09.2023', buildTime: '70дн', status: 'Отложен', mrBranded: true },
  { id: 'proj21', title: 'Цифровое наследие', subtitle: 'Фонд Хворостовского', website: 'https://hvorostovsky.com', images: [], videos: [], tags: ['Стратегия', 'R&D', 'Бренд', 'Веб', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '27.06.2023', buildTime: '40дн', status: 'Запущен', mrBranded: true },
  { id: 'proj22', title: 'Бассейн мечты', subtitle: 'Блумкидс', website: null, images: [], videos: [], tags: ['ИИ', 'Чекап', 'Стратегия', 'R&D', 'Бренд', 'Упаковка', 'Веб', 'Анимация', 'Видео', 'Лояльность', 'Стандарты', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '10.12.2022', buildTime: '235дн', status: 'Отложен', mrBranded: true },
  { id: 'proj23', title: 'Фитнес-экосистема', subtitle: 'FIZ Культура', website: 'https://fizkultura63.ru', images: [], videos: [], tags: ['ИИ', 'Анимация', 'Видео', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '12.05.2022', buildTime: '110дн', status: 'Отложен', mrBranded: false },
  { id: 'proj24', title: 'Платформа события', subtitle: 'World Plastics Summit 2022', website: null, images: [], videos: [], tags: ['ИИ', 'R&D', 'Бренд', 'Упаковка', 'Веб', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '24.03.2022', buildTime: '50дн', status: 'Запущен', mrBranded: true },
  { id: 'proj25', title: 'Крафт-франшиза', subtitle: 'Ермолаевъ', website: 'https://ermolaev.beer/', images: [], videos: [], tags: ['ИИ', 'Лояльность', 'Стандарты', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '27.12.2021', buildTime: '70дн', status: 'Отложен', mrBranded: false },
  { id: 'proj26', title: 'Образовательный профайл', subtitle: 'Modelex Education', website: 'https://modelex.mc', images: [], videos: [], tags: ['ИИ', 'R&D', 'Бренд', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '01.06.2021', buildTime: '90дн', status: 'Запущен', mrBranded: true },
  { id: 'proj27', title: 'Культурный профайл', subtitle: 'GALA RUSSE', website: null, images: [], videos: [], tags: ['ИИ', 'R&D', 'Бренд', 'Веб'], caseUrl: null, behanceUrl: null, launchDate: '02.04.2021', buildTime: '60дн', status: 'Запущен', mrBranded: true },
  { id: 'proj28', title: 'Новый персонаж', subtitle: 'Желток Белток', website: null, images: [], videos: [], tags: ['R&D', 'Автоматизация', 'Бренд'], caseUrl: null, behanceUrl: null, launchDate: '18.11.2020', buildTime: '55дн', status: 'Запущен', mrBranded: true },
  { id: 'proj29', title: 'Сервисный профайл', subtitle: 'EASYBUSY', website: 'https://easybusy.fr/', images: [], videos: [], tags: ['ИИ', 'R&D', 'Бренд', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '21.09.2020', buildTime: '60дн', status: 'Запущен', mrBranded: true },
  { id: 'proj30', title: 'Маркетинговый контур', subtitle: 'SMSTRETCHING', website: 'https://smstretching.ru', images: [], videos: [], tags: ['ИИ', 'Стратегия', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '02.03.2020', buildTime: '30дн', status: 'Отложен', mrBranded: false },
  { id: 'proj31', title: 'Цифровая витрина', subtitle: 'WOODLED', website: 'https://woodled.ru', images: [], videos: [], tags: ['ИИ', 'Автоматизация', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '16.02.2020', buildTime: '60дн', status: 'Запущен', mrBranded: false },
  { id: 'proj32', title: 'Новая стратегия', subtitle: 'SMSTRETCHING', website: 'https://smstretching.ru', images: [], videos: [], tags: ['ИИ', 'Лояльность'], caseUrl: null, behanceUrl: null, launchDate: '08.02.2020', buildTime: '130дн', status: 'Запущен', mrBranded: false },
  { id: 'proj33', title: 'Витрина бренда', subtitle: 'RAW BITES', website: null, images: [], videos: [], tags: ['R&D', 'Автоматизация', 'Бренд', 'Лояльность'], caseUrl: null, behanceUrl: null, launchDate: '30.11.2019', buildTime: '90дн', status: 'Запущен', mrBranded: true },
  { id: 'proj34', title: 'Конструктор праздника', subtitle: 'СУПЕРЛЕНД', website: 'https://superland.ru', images: [], videos: [], tags: ['ИИ', 'Чекап', 'Анимация', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '22.08.2018', buildTime: '50дн', status: 'Отложен', mrBranded: false },
  { id: 'proj35', title: 'Фирменный магазин', subtitle: 'Dymicana', website: null, images: [], videos: [], tags: [], caseUrl: null, behanceUrl: null, launchDate: '18.11.2016', buildTime: '90дн', status: 'Запущен', mrBranded: false },
  { id: 'proj36', title: 'Запуск на полку', subtitle: 'Чишминский', website: null, images: [], videos: [], tags: ['ИИ', 'R&D', 'Автоматизация', 'Бренд', 'Видео', 'Лояльность', 'Стандарты', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '01.06.2016', buildTime: '150дн', status: 'Запущен', mrBranded: true },
  { id: 'proj37', title: 'Единая доставка', subtitle: 'Milimon', website: 'https://milimon.ru', images: [], videos: [], tags: ['ИИ', 'Стратегия', 'CJM', 'Лояльность', 'Продажи'], caseUrl: null, behanceUrl: null, launchDate: '01.04.2016', buildTime: '60дн', status: 'Запущен', mrBranded: false },
  { id: 'proj38', title: 'Центр психологической помощи', subtitle: 'Школа Позитивной Психологии', website: null, images: [], videos: [], tags: ['ИИ', 'R&D', 'Бренд', 'Стандарты'], caseUrl: null, behanceUrl: null, launchDate: '01.06.2011', buildTime: '95дн', status: 'Отложен', mrBranded: true },
  { id: 'proj39', title: 'Ресторан и Гриль', subtitle: 'Морошка', website: null, images: [], videos: [], tags: ['R&D', 'Автоматизация', 'Бренд', 'Стандарты'], caseUrl: null, behanceUrl: null, launchDate: '01.11.2010', buildTime: '125дн', status: 'Запущен', mrBranded: true }
])
