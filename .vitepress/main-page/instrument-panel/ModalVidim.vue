...
<template>
  <div class="modal-vidim">
    ...
    <h4 class="md-h4">Не аудит. Не контракт на полгода</h4>
    <p class="md-text">Один разговор, после которого вы видите свой бизнес иначе.</p>
    <p class="md-text">Это разговор о будущем вашего рынка с командой, которая видит на 2 года вперёд. 45 запусков — от ресторанов до международных саммитов — дают нам силу видеть новые возможности для ролста.</p>
