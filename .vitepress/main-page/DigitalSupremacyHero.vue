...
const tips = [
  { id: 1, text: 'Знаете, чего хотите.', bold: 'Сигнал вместо шума.', normal: 'Что было, что будет?<br>Знаем, а не гадаем.' },
  { id: 2, text: 'Модуль Роста запускает.', bold: 'На шаг впереди.', normal: 'Конкуренты обсуждают —<br>вы уже запустили.' },
]
