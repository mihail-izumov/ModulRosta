...
<template>
<div class="ip">
  <h1 class="tt">От проблемы до работающей системы.</h1>
...
.sub{font-family:'Inter',sans-serif;font-size:34px;font-weight:400;color:rgba(0,255,136,.6);text-align:center;margin:0 0 96px;letter-spacing:1px;line-height:1.3}
@media(max-width:768px){.tt{font-size:24px;letter-spacing:2px;margin-bottom:12px}.sub{font-size:18px;margin-bottom:56px}.ip{padding:48px 16px 16px}}
...
.pt{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-family:'Inter',sans-serif;font-weight:700;font-size:23px;color:#00ff88;text-shadow:0 0 15px rgba(0,255,136,.6);text-align:center;opacity:0;transition:opacity 1s ease-out}
