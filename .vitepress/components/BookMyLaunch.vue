    ...
    <div class="bml-container">
      ...
      <div v-else class="bml-success">
        <div class="bml-success-icon">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
        </div>
...
.bml-field.focused { border-bottom-color: #f59e0b; }
...
.bml-field-label.focused { color: #f59e0b; }
.bml-field-input { position: absolute; left: 0; bottom: 10px; width: 100%; background: transparent; border: none; color: #f59e0b; font-size: 14px; font-family: 'Inter', sans-serif; font-weight: 400; letter-spacing: 1px; outline: none; caret-color: #f59e0b; padding: 0; }
...
.bml-toggle.active { background: rgba(245,158,11,0.12) !important; border-color: #f59e0b !important; color: #f59e0b !important; font-weight: 600 !important; }
...
.bml-progress-fill.complete { background: #f59e0b; }
...
.bml-progress-count.complete { color: #f59e0b; }
...
.bml-dot.ready { background: #f59e0b; box-shadow: 0 0 8px rgba(245,158,11,0.6); }
...
.bml-submit.ready { border-color: #f59e0b !important; color: #f59e0b !important; cursor: pointer !important; }
.bml-submit.ready:hover { background: #f59e0b !important; color: #000 !important; }

/* Success */
.bml-success { text-align: center; padding-top: 100px; }
.bml-success-icon { width: 64px; height: 64px; border-radius: 50%; border: 2px solid #f59e0b; display: flex; align-items: center; justify-content: center; margin: 0 auto 28px; }
