...
<template>
  ...
  <div class="panel-mr">
    ...
    <div v-show="activeTab === 'step-4'" class="content-mr">
      ...
      <p class="intro-p">
        На основе анализа отзывов выставляем каждому конкуренту (включая вашу компанию) оценки от 1 до 10 по каждому из 10 критериев. Без приукрашивания, без политкорректности — только факты из отзывов клиентов.
      </p>
      <div class="result-block">
    ...
    <div v-show="activeTab === 'result'" class="content-mr">
      ...
      <div class="cards-grid">
        <div class="result-card">
          ...
          <p>9 конкурента в трёх сегментах и понимание, с кем вас сравнивают гости при выборе</p>
        </div>
      ...
      <div class="result-block">
        ...
        <a href="/invest/sim" target="_blank" class="calc-button">Тест-драйв</a>
      </div>
    </div>
  </div>
</template>
